...
export const projects: Project[] = [
  {
    ...
    result: "진행 중",
    period: "2026.06 – 현재",
    org: "데이콘 / 행안부·NIA·조달청(주관) 위탁",
    role: "PL",
    summary:
      "불법사항 근절을 위한 수요기관 자체입찰 모니터링 모델 개발 과제. 행안부·NIA·조달청(주관) 위탁사업, PL로 수행 중.",
  ...
  },
  {
    ...
    org: "데이콘 / 행안부·NIA·한국교통안전공단(주관) 위탁",
    role: "PL",
    summary:
    ...
    body: [
      {
        heading: "배경",
        text: "운수종사자의 검사 결과와 사고 이력으로 교통사고 위험을 사전 식별하는 시스템이 필요했습니다. 2025년 같은 주제 경진대회 솔루션(상위 7.8%)을 출발점으로 삼아 실제 운영 가능한 플랫폼으로 확장했고, 외부망이 차단된 폐쇄망 환경에서 운영되어야 한다는 제약에서 구조를 잡았습니다.",
      },
      {
        heading: "접근",
    ...
    metrics: [
      ...
      { label: "배포 zip (공개 구현)", value: "약 400MB" },
    ],
    architecture: {
      ...
      note: "공개 구현 기준 시스템 구성입니다. 성능 수치는 실제 데이터로 학습해 저장된 결과이며, 검사 데이터가 저장소에 없어 저장소만으로는 재현되지 않습니다.",
    },
  },
  {
